...
<html>
	...
	<div id="header">
			...
			<tr><td><div><marquee direction="up" width="300px" truespeed="truespeed" onmouseover="stop()" onmouseout="start()" style="color: red;">Last Date of fee Submission is today
	...
	<div id="sidebar">
			...
			<div id="header">
					<h4>
						Designed and programmed by shubh
						</h4>
			</div>
